...
lab_hr = Label(clock, text="00", font=('Time New Roman', 60, "bold"),   # Make a box for Hour and give colors
               bg="red", fg="white")
lab_hr.place(x=120, y=60, height=110, width=100)                        # Dimensions of the box "00"

lab_hr_txt = Label(clock, text="hour", font=('Time New Roman', 20, "bold"),
                   bg="red", fg="white")                                # Color box to write "Hour" and dim.
lab_hr_txt.place(x=120, y=190, height=30, width=100)

# *** Minute ***

lab_min = Label(clock, text="00", font=('Time New Roman', 60, "bold"),
               bg="red", fg="white")                                    # Make a box for MIN and give colors
lab_min.place(x=340, y=60, height=110, width=100)                       # Dimensions of the box "00"
...
lab_sec = Label(clock, text="00", font=('Time New Roman', 60, "bold"),
               bg="red", fg="white")                                     # Make a box for sec and give colors
lab_sec.place(x=560, y=60, height=110, width=100)
...
lab_am = Label(clock, text="00", font=('Time New Roman', 50, "bold"),
               bg="red", fg="white")                                     # Make a box for AM/PM and give colors
lab_am.place(x=780, y=60, height=110, width=100)
...
lab_mo = Label(clock, text="00", font=('Time New Roman', 60, "bold"),   # Make a box for Hour and give colors
               bg="red", fg="white")
lab_mo.place(x=340, y=270, height=110, width=100)                        # Dimensions of the box "00"
